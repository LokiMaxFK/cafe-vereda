...
export function InventoryPage() {
  ...
  const activeMovements = useMemo(() => movements.filter((movement) => activeItems.some((item) => item.id === movement.itemId)), [movements, activeItems]);
