      ...
      <div className="space-y-5">
        ...
        <Panel className="p-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <FieldLabel label="Copias predeterminadas de comanda" hint="Se aplicará a comandas reales en la siguiente fase."><SelectField value={settings.commandCopies} onChange={(event) => updateSettings({ commandCopies: Number(event.target.value) as 1 | 2 })}><option value="1">1 copia</option><option value="2">2 copias</option></SelectField></FieldLabel>
          </div>
        </Panel>
